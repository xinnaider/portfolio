...
<template>
  ...
  <section v-if="isManga" id="sobre" class="relative bg-black py-0 overflow-hidden">
  ...
  <!-- VIOLET ABOUT (original) -->
  <section v-else id="sobre" class="relative bg-surface-white py-16 sm:py-24 lg:py-36 overflow-hidden">
