...
<template>
  <!-- MANGA HERO -->
  <section v-if="isManga" class="relative min-h-dvh flex items-center overflow-hidden bg-[#0a0a0a] border-b-2 border-white">
    <!-- Manga decorations -->
    <MangaSpeedLines />
  ...
  <!-- VIOLET HERO (original) -->
  <section v-else class="relative min-h-dvh bg-surface-black flex items-center overflow-hidden">
    <div
