...
<template>
  <section class="relative min-h-dvh bg-surface-black flex items-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 pt-28 md:pt-32 pb-20 w-full">
      ...
      <h1 class="font-display font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-8xl text-white leading-[0.9] tracking-tighter">
        {{ displayedText }}<span
          v-if="showCursor"
      ...
      <p class="text-white/70 text-base md:text-lg mt-8 max-w-lg leading-relaxed">
