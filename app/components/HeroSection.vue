    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 pt-28 md:pt-32 pb-20 w-full">
      ...
      <div class="flex flex-col sm:flex-row gap-6 sm:gap-12 mt-10">
        <div>
          ...
          <p class="text-white text-sm sm:text-base">São Paulo – SP, Brasil</p>
        </div>
        <div>
          <p class="text-text-muted text-[10px] sm:text-xs uppercase tracking-[2px] sm:tracking-[3px] mb-1">Conectar</p>
          <a
        ...
        <div>
          <p class="text-text-muted text-[10px] sm:text-xs uppercase tracking-[2px] sm:tracking-[3px] mb-1">Currículo</p>
          <button
            class="inline-flex items-center gap-2 text-white hover:text-accent transition-colors duration-200 text-sm sm:text-base"
          ...
          >
            ...
            {{ isGenerating ? 'Gerando...' : 'Download CV' }}
          </button>
        </div>
      </div>
    </div>
